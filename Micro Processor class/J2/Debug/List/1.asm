...
; 0000 008A 
; 0000 008B       //PORTA= 0b11111111;
; 0000 008C       //delay_ms(100);
; 0000 008D       //PORTA= 0b00000000;
; 0000 008E      // delay_ms(100);
; 0000 008F 
; 0000 0090       PORTA= 0b00000001;
	LDI  R30,LOW(1)
	RCALL SUBOPT_0x0
; 0000 0091       delay_ms(100);
; 0000 0092       PORTA= 0b00000010;
	LDI  R30,LOW(2)
	RCALL SUBOPT_0x0
; 0000 0093       delay_ms(100);
; 0000 0094       PORTA= 0b00000100;
	LDI  R30,LOW(4)
	RCALL SUBOPT_0x0
; 0000 0095       delay_ms(100);
; 0000 0096       PORTA= 0b00001000;
	LDI  R30,LOW(8)
	RCALL SUBOPT_0x0
...
; 0000 009A       PORTA= 0b00100000;
	LDI  R30,LOW(32)
	RCALL SUBOPT_0x0
; 0000 009B       delay_ms(100);
; 0000 009C       PORTA= 0b01000000;
	LDI  R30,LOW(64)
	RCALL SUBOPT_0x0
; 0000 009D       delay_ms(100);
; 0000 009E       PORTA= 0b10000000;
	LDI  R30,LOW(128)
	RCALL SUBOPT_0x0
