...
_0x0:
	.DB  0x50,0x6F,0x75,0x79,0x61,0x20,0x4D,0x65
	.DB  0x68,0x72,0x62,0x61,0x62,0x61,0x6B,0x0
	.DB  0x31,0x30,0x31,0x39,0x34,0x30,0x34,0x31
	.DB  0x31,0x33,0x36,0x36,0x0,0x54,0x68,0x75
	.DB  0x72,0x73,0x64,0x61,0x79,0x0,0x37,0x2D
	.DB  0x31,0x2D,0x32,0x30,0x32,0x31,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 009C        lcd_putsf("Pouya Mehrbabak");   //student name
	__POINTW2FN _0x0,0
	RCALL SUBOPT_0x1
; 0000 009D        lcd_gotoxy(0,1);
; 0000 009E        lcd_putsf("101940411366");   //student number
	__POINTW2FN _0x0,16
	RCALL SUBOPT_0x2
...
; 0000 00A3        lcd_putsf("Thursday");   //day
	__POINTW2FN _0x0,29
	RCALL SUBOPT_0x1
; 0000 00A4        lcd_gotoxy(0,1);
; 0000 00A5        lcd_putsf("7-1-2021");   //date
	__POINTW2FN _0x0,38
	RCALL SUBOPT_0x2
