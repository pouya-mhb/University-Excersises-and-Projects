...
; 0000 0088       {
; 0000 0089 
; 0000 008A       // 7seg common cathode
; 0000 008B       PORTA= 0x3f;  //0
	LDI  R30,LOW(63)
	RCALL SUBOPT_0x0
; 0000 008C       delay_ms(500);
; 0000 008D       PORTA= 0x06;  //1
	LDI  R30,LOW(6)
	RCALL SUBOPT_0x0
; 0000 008E       delay_ms(500);
; 0000 008F       PORTA= 0x5b;  //2
	LDI  R30,LOW(91)
	RCALL SUBOPT_0x0
; 0000 0090       delay_ms(500);
; 0000 0091       PORTA= 0x4f;  //3
	LDI  R30,LOW(79)
	RCALL SUBOPT_0x0
; 0000 0092       delay_ms(500);
; 0000 0093       PORTA= 0x66;  //4
	LDI  R30,LOW(102)
	RCALL SUBOPT_0x0
; 0000 0094       delay_ms(500);
; 0000 0095       PORTA= 0x6d;  //5
	LDI  R30,LOW(109)
	RCALL SUBOPT_0x0
; 0000 0096       delay_ms(500);
; 0000 0097       PORTA= 0x7d;  //6
	LDI  R30,LOW(125)
	RCALL SUBOPT_0x0
; 0000 0098       delay_ms(500);
; 0000 0099       PORTA= 0x07;  //7
	LDI  R30,LOW(7)
	RCALL SUBOPT_0x0
; 0000 009A       delay_ms(500);
; 0000 009B       PORTA= 0x7f;  //8
	LDI  R30,LOW(127)
	RCALL SUBOPT_0x0
; 0000 009C       delay_ms(500);
; 0000 009D       PORTA= 0x6f;  //9
	LDI  R30,LOW(111)
	RCALL SUBOPT_0x0
